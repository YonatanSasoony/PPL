...
export interface LazyValue{ tag:"LazyValue", cexp:CExp}
export const makeLazyValue = (cexp:CExp) : LazyValue => ({tag:"LazyValue", cexp:cexp});
export const isLazyValue = (x:any) : x is LazyValue => x.tag === "LazyValue";

export type SExpValue = number | boolean | string | PrimOp | Closure | SymbolSExp | EmptySExp | CompoundSExp | LazyValue ;
